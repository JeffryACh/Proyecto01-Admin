...
fun MechanicBottomNavBar(
    ...
    NavigationBar(
        ...
        NavigationBarItem(
            ...
            icon = { Icon(Icons.Default.Build, contentDescription = "Mantenimiento", modifier = Modifier.size(26.dp).offset(y = 4.dp)) },
            label = { Text("Mantenimiento", style = MaterialTheme.typography.labelMedium) },
            colors = NavigationBarItemDefaults.colors(
                selectedIconColor = AccentBlue,
                selectedTextColor = AccentBlue,
                unselectedIconColor = MaterialTheme.colorScheme.onSurfaceVariant,
