...
fun BottomNavBar(
    ...
    NavigationBar(
        ...
        NavigationBarItem(
            ...
            icon = { Icon(Icons.Default.DirectionsCar, contentDescription = "Vehículo", modifier = Modifier.size(26.dp).offset(y = 4.dp)) },
            label = { Text("Vehículo", style = MaterialTheme.typography.labelMedium) },
            colors = NavigationBarItemDefaults.colors(
                selectedIconColor = AccentBlue,
                selectedTextColor = AccentBlue,
                unselectedIconColor = MaterialTheme.colorScheme.onSurfaceVariant,
